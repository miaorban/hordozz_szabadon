...
export default function Introduction() {
  return (
    <>
      <p
        className="font-medium text-3xl md:text-7xl mb-4 md:mb-16 p-8 sm:p-0 
        whitespace-pre-line"
      >
        Szeretnék Veled dolgozni. Ha Te is, keress meg elérhetőségeim egyikén!
      </p>
      ...
      >
        <div className="flex flex-col px-8 xs:px-16 md:basis-3/6">
          ...
          <div className="flex">
            ...
            >
              <Image width={150} height={50} alt="TikTok" src="/tiktok.png" />
            </Link>
        ...
        md:basis-1/2"
        >
          <Image alt="Hordozó ember" src={hordozoEmber5} height={350} />
        </div>
      </div>
    </>
  );
